...
if (!COOKIE.yuedongzutokenVal) {
    ...
    yuedongzutokenArr=[ {"imei":"7fddd73e-ffdf-05d5-69f5-fdcbff3d793e","store":"0","ini":"29","version":"6","platform":"1","Authorization":"bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3GTCrLeSwV_sAJV2v7paFNLCVui1HCAK7yvei4BsD9U","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; YAL-AL10 Build/HUAWEIYAL-AL10)","Host":"yuedongzu.yichengw.cn","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"}]
...
async function all() {
    ...
    for (let i = 0; i < Length; i++) {
        ...
        header = {"imei":"7fddd73e-ffdf-05d5-69f5-fdcbff3d793e","store":"0","ini":"29","version":"6","platform":"1","Authorization":"bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3GTCrLeSwV_sAJV2v7paFNLCVui1HCAK7yvei4BsD9U","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; YAL-AL10 Build/HUAWEIYAL-AL10)","Host":"yuedongzu.yichengw.cn","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"};
        O = (`${$.name + (i + 1)}🔔`);
        await console.log(`-------------------------\n\n🔔开始运行【${$.name+(i+1)}】`)
